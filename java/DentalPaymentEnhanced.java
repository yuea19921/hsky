...
public class DentalPaymentEnhanced extends JFrame
{
   ...
   private void calculateJButtonActionPerformed( ActionEvent event )
   {
      ...
      if ( ( patient.equals( "" ) ) || 
         ...
         !xRayJCheckBox.isSelected() && !fluorideJCheckBox.isSelected() && !rootCanalJCheckBox.isSelected() && !otherJCheckBox.isSelected() ) )
      {
      ...
      else // otherwise, do calculations
      {
         ...
         if(otherJCheckBox.isSelected()){
        	 total += Integer.parseInt(otherPriceJTextField.getText());
         }
